...
echo "* * * * * /usr/bin/php -d memory_limit=-1 -d max_execution_time=0 /usr/share/nginx/html/applications/core/interface/task/task.php fb05731ced1c5f8ddecb7a9719df7c94" >> /etc/crontabs/root
